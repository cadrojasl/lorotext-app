    ...
    <footer className="text-white pt-12 pb-6" style={{ backgroundColor: "#0D5C5C" }}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Categories */}
          <div>
            <h4 className="font-semibold text-xs uppercase tracking-widest mb-4" style={{ color: "#FFFFFF" }}>Categorías</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-xs uppercase tracking-widest mb-4" style={{ color: "#FFFFFF" }}>Contacto</h4>
          ...
          {/* Info */}
          <div>
            <h4 className="font-semibold text-xs uppercase tracking-widest mb-4" style={{ color: "#FFFFFF" }}>Información</h4>
            <ul className="space-y-2.5 text-sm" style={{ color: "rgba(255,255,255,0.7)" }}>
              {[
