...
import { Plus, Edit, Trash, Star, Package, Tag, Settings, Home, LogOut, X, Check, Upload, Loader2 } from "lucide-react";
    ...
    <div>
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="rounded-full flex items-center justify-center text-white font-black" style={{ width: 28, height: 28, background: `linear-gradient(135deg, ${BRAND.BLUE} 0%, #2563EB 100%)`, fontSize: 12 }}>🦜</div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-7">
        ...
        <div className="flex gap-1 bg-white rounded-2xl border border-gray-100 p-1.5 mb-6 w-fit">
          {[
            { href: "/admin/productos", label: "Productos", Icon: Package, active: true },
